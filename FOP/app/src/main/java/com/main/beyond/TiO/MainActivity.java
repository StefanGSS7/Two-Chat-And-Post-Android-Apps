...
public class MainActivity extends AppCompatActivity {
    ...
    String receverFullName,currentUserId,currentCategory = "Сексуална Експлатација";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* currentUserIdMessagesRef = FirebaseDatabase.getInstance().getReference().child("Messages").child(currentUserId);
*/
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Дома");
